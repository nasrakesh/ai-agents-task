...
async def main():
    ...
    await call_agent_and_print(capital_runner, root_agent, SESSION_ID_TOOL_AGENT, '{"country": "France"}')
    await call_agent_and_print(capital_runner, root_agent, SESSION_ID_TOOL_AGENT, '{"country": "Canada"}')
